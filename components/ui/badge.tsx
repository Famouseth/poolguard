  ...
  "inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        profit: "border-transparent bg-green-500/15 text-profit",
        loss: "border-transparent bg-red-500/15 text-loss",
        warn: "border-transparent bg-yellow-500/15 text-warn",
      },
    },
